...
/**************************************************************************************
 ...
 Copyright © 1998 - 2007 Autodesk, Inc. and/or its licensors.
 All Rights Reserved.
...
#include <fbxfilesdk/fbxfilesdk_nsbegin.h>
    ...
    // Constants
    #define  K_NO_TRACE          0            // Tracing disabled, this level must not 
                                            // be used with the KTrace function
    #define  K_ASSERT_ONLY_TRACE 1            // Show only assert traces
    #define  K_NORMAL_TRACE      3            // Descriptive trace
    #define  K_ALL_TRACE         4            // Highly detailled level of trace
    #define  K_DEFAULT_TRACE     20           // Default value, K_TRACE_LEVEL 
                                            // environment variable is used when
                                            // level TraceLevel is set to that value
                                            // Never use this value as an argument 
                                            // to KTrace
