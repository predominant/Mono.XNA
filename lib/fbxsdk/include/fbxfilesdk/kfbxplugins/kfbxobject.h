    ...
    class KFBX_DLL KFbxObject : public KFbxPlug
    {
        ...
        public:
            ...
            /** Set the namespace of the object.
			  * \param pNameSpace Set the namespace as pNameSpace
              * \return Return a \c NULL terminated string.
              */
            void SetNameSpace(KString pNameSpace);

            /** Return an array of all the namespace of the object
			  * \param identifier The identifier of the namespace.
              * \return Return a \c NULL terminated string.
              */
			...
			/** Strip the prefix of pName
			  ...
			  * \return lName with prefix stripped.
			  */
            static KString StripPrefix(KString& lName);

			/** Strip the prefix of pName
			  * \param pName Whose prefix is stripped.
			  * \return A temporary string with prefix stripped.
			  */
