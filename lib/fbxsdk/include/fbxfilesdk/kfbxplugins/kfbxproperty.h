...
class KFbxCriteria;
    ...
    class KFBX_DLL KFbxProperty : private FbxPropertyFlags
    {
        ...
        public:
			...
			/** check if the given property value has changed from its default.
			  * \param pProperty Property object that is tested.
			  * \return true if the the property value is still the default one.
			  */
            ...
            /** get and evaluate pulls on a value
			  * \param pValue Pointer to the value. 
			  * \param pValueType The data type of the value.
			  * \param pEvaluateInfo The evaluation information.
              * \return true if it was succesfull and type were compatible.
              */
            ...
            /** get value function
              ...
              * \return The value in a temporary variable.
              */
        ...
        typedef enum { eUNIDENTIFIED,eBOOL,eREAL,eCOLOR,eINTEGER,eVECTOR,eLIST,eMATRIX,eSTRING1 } EUserPropertyType;
