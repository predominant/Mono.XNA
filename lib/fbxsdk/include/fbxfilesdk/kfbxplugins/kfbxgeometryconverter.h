...
public:
    ...
    */
    ...
    //set UVs and Vertex Color, when building new mesh. 
    bool SetUVsAndVertexColor(KFbxMesh *pNewMesh, KFbxMesh *pMesh, int pPolygonIndex, int pPolyPointIndex, int pLoopIndex, bool pIsSearched);
